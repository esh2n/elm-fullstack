...
import Backend.Main
import Backend.InterfaceToHost_Root.Generated_ab2dd9bd
import Base64
import Dict
import Set
import Json.Decode
...
setStateFromString =
    Json.Decode.decodeString Backend.InterfaceToHost_Root.Generated_ab2dd9bd.jsonDecode_2ea38cf1d1
    >> Result.mapError Json.Decode.errorToString
...
jsonEncodeDeserializedState =
    Backend.InterfaceToHost_Root.Generated_ab2dd9bd.jsonEncode_2ea38cf1d1

jsonDecodeDeserializedState =
    Backend.InterfaceToHost_Root.Generated_ab2dd9bd.jsonDecode_2ea38cf1d1
